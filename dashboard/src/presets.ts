/**
 * Provider presets — known provider templates.
 * This is a UI configuration, not hardcoded gateway logic.
 * Add new providers here to make them available as "Quick Add" options.
 */
